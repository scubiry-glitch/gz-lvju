...
CITIES = [
    {
        ...
        "districts": ["鼓楼区", "玄武区", "秦淮区", "建邺区", "栖霞区", "雨花台区", "江宁区", "浦口区", "六合区", "溧水区", "高淳区"],
        "projects": [
            ...
            {"district": "六合区", "name": "安居·江北人才公寓", "address": "六合区江北大道", "price_from": 1500,
             "cover": BZF_COVERS[7],
             "units": [("30 平", 30, 1500), ("45 平", 45, 2100), ("60 平", 60, 2800)]},
            {"district": "溧水区", "name": "宁慧·溧水空港寓", "address": "溧水区柘塘街道", "price_from": 1200,
             "cover": BZF_COVERS[8],
             "units": [("32 平", 32, 1200), ("48 平", 48, 1800)]},
            {"district": "高淳区", "name": "宁慧·高淳慢城寓", "address": "高淳区淳溪街道", "price_from": 1100,
             "cover": BZF_COVERS[9],
    ...
    },
    {
        ...
        "hero_bg_image": "assets/juzhu/sy/city/hero.jpg",
        "districts": ["云岩区", "南明区", "观山湖区", "花溪区", "乌当区", "白云区", "清镇市", "修文县", "息烽县", "开阳县"],
        "projects": [
            ...
            {"district": "乌当区", "name": "黔居·乌当温泉青年家", "address": "乌当区新添大道", "price_from": 1100,
             "cover": BZF_COVERS[5],
             "units": [("35 平", 35, 1100), ("50 平", 50, 1650)]},
            {"district": "清镇市", "name": "黔居·清镇职教城寓", "address": "清镇市职教城", "price_from": 900,
             "cover": BZF_COVERS[6],
             "units": [("30 平", 30, 900), ("45 平", 45, 1350)]},
            {"district": "修文县", "name": "黔居·修文龙场寓", "address": "修文县龙场街道", "price_from": 800,
             "cover": BZF_COVERS[7],
             "units": [("35 平", 35, 800), ("50 平", 50, 1250)]},
            {"district": "息烽县", "name": "黔居·息烽温泉寓", "address": "息烽县永靖镇", "price_from": 750,
             "cover": BZF_COVERS[8],
             "units": [("32 平", 32, 750)]},
            {"district": "开阳县", "name": "黔居·开阳云开寓", "address": "开阳县硒城街道", "price_from": 700,
             "cover": BZF_COVERS[9],
             "units": [("40 平", 40, 700), ("55 平", 55, 1100)]},
        ],
        "trade": {
