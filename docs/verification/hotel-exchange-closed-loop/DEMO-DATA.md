...
| 实体 | 数量 | 说明 |
|---|---|---|
| 事业群商家（jz_vendors+merchants） | 5 | 柏曼/城市便捷/宜尚/怡程/中寓（酒店通兑试点演示），vendor_no 前缀 `hotel-exchange-demo-v1:` |
| 抽样酒店门店（stores） | 48 | 每档 8 家（品牌分层 + hotel_code 字典序轮转，确定性可复算）；payload：`kind:'hotel'` + `exchange_tier/hotel_code/hotel_brand/hotel_region/hotel_branch/hotel_war_zone`；city 挂贵阳（名单为全国门店，通兑跨城属预期）；capacity 3 |
...
抽样示例（t80，5 品牌 8 家）：城市便捷郑州巩义火车站康百万庄园店、城市精选孝感安陆东大时代广场店、宜尚滨州博兴银座店、柏曼上海虹桥火车站国展中心店、精途武汉长丰大道园博园店、城市便捷禹州大禹像胖东来店、城市精选贵阳高铁东站店、宜尚东营东城南一路店。完整抽样可由 `require('commerce/hotel-exchange-demo.cjs').sampleHotels()` 复算。
