...
const ROUTES = [
  ...
  {method:'GET',re:'^/api/commerce/v1/admin/settlement/compensations$',perm:'commerce.fund.read',act:null,res:'commerce'},
  {method:'POST',re:'^/api/commerce/v1/admin/settlement/compensations$',perm:'commerce.fund.write',act:'commerce.fund.mutate',res:'commerce'},
  {method:'POST',re:'^/api/commerce/v1/admin/settlement/compensations/(\\d+)/review$',perm:'commerce.fund.review',act:'commerce.fund.review',res:'commerce',idGroup:1},
  ...
  {method:'GET',re:'^/api/commerce/v1/admin/settlement/alerts$',perm:'commerce.fund.read',act:null,res:'commerce'},
