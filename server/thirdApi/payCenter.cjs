 ...
 * 1、调用C2B支付下单v2/createOrder,入参收款信息recAndShareInfo 如何，是否
 * recAndShareInfo：{ merchantNo:"merchantNo_A",shareOrderMode:"0",
 *        shareOrderInfos:[
 *        {merchantNo:"merchantNo_A",amount:"101"，shareBizCode："02037200000000"}
 *    ]}
 * 2、调用ACN分账接口 给merchantNo_A，merchantNo_P分账，源商户就是下单传的merchantNo_A
 */
'use strict';
