...
(function () {
  ...
  const PRESETS = {
    ...
    sy_zj: {
      label: '沈阳 · 住建局',
      prov: { full: '辽宁省', short: '沈阳', capital: '沈阳',
              cities: ['沈阳','大连','鞍山','抚顺','本溪','丹东','锦州','营口','阜新','辽阳','盘锦','铁岭','朝阳','葫芦岛'],
              extraCities: ['新民','瓦房店','普兰店','庄河'] },
      dept: { short: '住建局', orgFull: '住房和城乡建设', stem: '住建', division: '监管处' },
      biz:  { term: '旅居住宿', termFull: '旅居住宿与惠居' },
      bank: { name: '盛京银行', div: '普惠金融部' },
      soe:  { full: '沈阳安居集团', mid: '安居集团', short: '安居集团' },
