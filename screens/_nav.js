    ...
    p: {
      ...
      groups: [
        ...
        { name: '🛠 × S 服务者（个人持证轨道）', items: [
          ...
          { id: 'jiazheng-api',    label: '新居住 · 本地生活 ↗', href: '../index.html?tab=jiazheng', icon: 'home', badge: 'API' },
        ...
        { name: '🏠 居住服务 · 本地生活', items: [
          ...
          { id: 'jz-schedule', label: '★ SKU 排班 ↗',         href: 'p-jz-schedule.html', icon: 'pulse' },
          { id: 'jz-worker',   label: '★ 服务者管理 ↗',       href: 'p-jz-worker.html',   icon: 'user' },
          { id: 'jiazheng-flow', label: '本地生活频道 ↗',   href: '../index.html?tab=jiazheng', icon: 'truck', badge: '11' },
          { id: 'life-topic', label: '杂志专题展开 ↗', href: '../juzhu-topic.html?id=new-home', icon: 'star', badge: '4' },
          { id: 'life-layouts', label: '布局四案对照 ↗', href: '../juzhu-life-layouts.html', icon: 'layers', badge: 'C–F' },
        ]},
      ],
    },
